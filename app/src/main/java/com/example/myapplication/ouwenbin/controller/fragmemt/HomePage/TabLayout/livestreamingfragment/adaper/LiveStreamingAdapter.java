package com.example.myapplication.ouwenbin.controller.fragmemt.HomePage.TabLayout.livestreamingfragment.adaper;
...
public class LiveStreamingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LiveStreamingAdapter(Context context, ArrayList<String> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    public class NormalHolder extends RecyclerView.ViewHolder {
        ...
        public NormalHolder(View itemView) {
            ...
            mTV = itemView.findViewById(R.id.live_name);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new NormalHolder(inflater.inflate(R.layout.live_streaming_item, parent, false));
    }
