...
public class VideoTopAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<String> mDatas;
    private int mCreatedHolder=0;
    public VideoTopAdapter(Context context, ArrayList<String> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new NormalHolder(inflater.inflate(R.layout.video_top_item, parent, false));
    }
